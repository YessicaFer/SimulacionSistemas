...
En los primeros dos casos, podemos usar la información de la componente que si cumple la restricción. Para facilitar los calculos se introduce una función que calcula la distancia de un punto a la región factible de acuerdo a lo siguiente:
