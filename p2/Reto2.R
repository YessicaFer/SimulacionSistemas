...
png("R2_distribucionNucleosInternos.png",width=1200,height=600)
...
png("R2_boxplotTamNucleos.png",width=1000,height=600)
...
png("R2_boxplotNumNucleos.png",width=1000,height=600)
...
#Hay diferencia entre el numero total de nucleos?
wilcox.test(f5,f10)
